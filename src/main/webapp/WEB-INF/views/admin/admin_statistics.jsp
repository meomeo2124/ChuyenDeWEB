	...
	<div class="row">
		<nav class="col-md-3 col-lg-2 d-none d-md-block admin-nav">
			<ul>
				...
				<li><a href="${pageContext.request.contextPath}/admin/statistics" class="active"><span class="icon"><i class="bi bi-bar-chart-line"></i></span><span class="text">Thống kê doanh thu</span></a></li>
