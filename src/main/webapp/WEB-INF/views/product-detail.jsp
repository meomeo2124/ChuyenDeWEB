...
<%-- 1. Bổ sung thư viện Format và ép kiểu Tiếng Việt --%>
    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <%-- 2. Đổi định dạng tiền VNĐ cho Sản phẩm chính --%>
                <div class="fs-5 mb-5">
                        <span class="text-primary fw-bold text-danger fs-3">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="text-center">
                                            ...
                                            <div class="d-flex justify-content-center small text-warning mb-2">
                                                ...
                                                <%-- 3. Đổi định dạng tiền VNĐ cho các sản phẩm gợi ý --%>
